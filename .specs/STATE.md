...
- **Next step**: **Batch 6 = Phase 7 (T38–T42)** dispatched on the SESSION model (androidx/Material: manifest pin bump — MUST sync `EngineArtifacts.kt` + `build.gradle.kts` per debt #2; library resources+classpath wiring — partially addresses T18 real-host debt; theme-aware Factory2; Material gallery parity; quirks doc). Downloads Material AAR closure (network).
- **Batch plan**: B1=P1✅ · B2=P2+P3✅ · B3=P4✅ · B4=P5✅ · B5=P6✅ · B6=P7(session)▶ · B7=P8(session) · B8=P9(sonnet) · B9=P10(sonnet) → Verifier (session).
- **Blockers**: none
